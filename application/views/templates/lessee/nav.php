        ...
        <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                <span class="pull-left">
                  <img id="img-top" class="media-object" width="25" height="25" src="<?php echo ($this->session->userdata('image') == '') ? site_url('uploads/default.gif') : site_url("uploads/".$this->session->userdata('image')); ?>" alt="">
                </span>
                &nbsp;
