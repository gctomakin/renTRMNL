...
$data['content'] = $this->load->view('templates/admin/nav', '', true);
$data['content'] .= $this->load->view('templates/admin/sidebar', '', true);

$wrapper = array(
  'content' => $content,
  'title' => $title
);
$data['content'] .= $this->load->view('templates/admin/wrapper', $wrapper, true);
